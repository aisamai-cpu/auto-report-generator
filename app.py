...
class App:
    def __init__(self, root):
        ...
        # Subtitulo
        tk.Label(root, text="Selecciona tu archivo de ventas (.csv o .xlsx)\ny genera tu reporte PDF automaticamente",
                 font=("Helvetica", 10), bg="#f0f4f8", fg="#444", justify="center",
                 pady=10).pack()
        ...
        tk.Button(root, text="📂  Seleccionar archivo de ventas",
                  ...
                  command=self.seleccionar_archivo).pack(pady=10)

        # Label archivo seleccionado
        self.label_archivo = tk.Label(root, text="Ningún archivo seleccionado",
    ...
    def seleccionar_archivo(self):
        ruta = filedialog.askopenfilename(
            ...
            filetypes=[("Archivos CSV y Excel", "*.csv *.xlsx")]
        )
        if ruta:
            self.archivo = ruta
